                        ...
                        <div class="col-lg-5">
                            <div class="input-group input-group-dynamic">
                                ...
                                <span class="input-group-btn">
                                    <button onclick="tampilProduk()" class="btn btn-info btn-flat" type="button"><i class="fa fa-arrow-right"></i>Cari</button>
                                </span>
                            </div><br>
                        </div>
                    </div>
                                ...
                                <div class="input-group input-group-dynamic">
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button onclick="tampilMember()" class="btn btn-info btn-flat" type="button"><i class="fa fa-arrow-right">Cari</i></button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
